...
export function pausesAndTextLength(initialSegments: TimedTextSegment[], audioData: number[], duration: number){
    const pauses = pauseIntervals(audioData, duration);
