...
export function makePauseAwareTextLength(kMeansIterations:number, k:number, fractionOfSpeech:number){
    const getIsSpeech = makeSpeechFinder(kMeansIterations, k, fractionOfSpeech)
